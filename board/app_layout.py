...
def build_layout(app):
    ...
    app.score_button=ttk.Button(board_header,text='数目 / 数子',width=10)
    app.score_button.pack(side='right',padx=(12,0))
    ...
    tk.Label(app.board_host,text='数目 / 数子：点按开关，长按查看、松开隐藏 · 棋谱自动保存',bg=PAPER,fg=MUTED,font=('Microsoft YaHei UI',9)).pack(side='bottom',anchor='w',padx=18,pady=(8,16))
